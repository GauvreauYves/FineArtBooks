...
Scene-referred development preserves the integrity and authenticity of captured raw sensor data. A [correction LUT](https://3dlutcreator.com/) made from a ColorChecker ensures color and luminance accuracy (ΔE00 < 2).  
